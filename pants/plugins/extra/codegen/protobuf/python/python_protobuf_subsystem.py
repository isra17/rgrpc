...
from extra.codegen.protobuf.python.additional_fields import ProtobufPythonResolveField
...
class PythonProtobufMypyPlugin(PythonToolRequirementsBase):
    ...
    default_lockfile_resource = ("extra.codegen.protobuf.python", "mypy_protobuf.lock")

class PythonProtobufGrpclibPlugin(PythonToolRequirementsBase):
    options_scope = "grpclib"
    help = "Configuration of the mypy-protobuf type stub generation plugin."

    default_requirements = ["grpclib>=0.4"]

    register_interpreter_constraints = True

    default_lockfile_resource = ("extra.codegen.protobuf.python", "grpclib.lock")
